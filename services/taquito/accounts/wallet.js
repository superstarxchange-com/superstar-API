...
const { DEFAULT_PASSPHRASE, ACCOUNT_PREFIX, MNEMONIC_LENGTH } = require("../../../constants");
...
const isValidAddress = (tzAddress) => {
    try{
        taquito.b58cdecode(tzAddress, ACCOUNT_PREFIX.tz1);
        return true;
